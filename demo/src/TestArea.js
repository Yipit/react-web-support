    ...
    return (
      <div className="demo-test-area--wrapper">
        <div className="demo-test-area--title">
          <div className="demo-test-area--title-main">react-web-support demo</div>
        ...
        <p className="demo-test-area--info">
          react-web-support is a chat window that allows you to build and add custom live chat to your sites. It includes only the react chat widget. There is no backend, and no communication system baked in.
          <br />
          <br/>
          For instructions on how to use react-web-support click <a href="https://github.com/kingofthestack/react-web-support">here</a>.
        </p>
      </div>
    )
  }
