...
var _DefaultMessage = require('./Messages/DefaultMessage');
...
var Launcher = function (_Component) {
  ...
  function Launcher() {
    ...
    _this.state = {
      ...
      messageList: [_DefaultMessage2.default],
      isOpen: false
    };
  ...
  Launcher.prototype.onSubmit = function onSubmit(message) {
    ...
    (0, _html2canvas2.default)(document.body, { scale: parseFloat((600 / window.innerWidth).toFixed(2)) }).then(function (canvas) {
